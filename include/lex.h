...
enum multi_tks {
	...
	TK_AND, TK_OR,
	TK_IF, TK_ELSE, TK_ELSEIF, TK_LOOP, TK_WHILE, TK_FOR, TK_FN, TK_STRUCT,TK_IMPORT,TK_IMPL,TK_NEW,TK_EXTERN,TK_ENUM,
	TK_IDENT,TK_BREAK, TK_FLOAT,TK_INT,TK_I8,TK_U8,TK_I16,TK_U16,TK_I32,TK_U32,TK_I64,TK_U64, TK_FALSE, TK_TRUE, TK_NIL
    ,TK_RETURN,
	TK_EOF,
};
